(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.SystemCapabilities = factory());
})(this, (function () { 'use strict';

  // Verificación de entorno del navegador
  const isBrowser$3 = typeof window !== 'undefined' && typeof navigator !== 'undefined' && typeof document !== 'undefined';
  ...
  class SystemDetector {
    ...
    getDeviceInfo() {
      return {
        ...
        deviceMemoryNote: navigator.deviceMemory ? 'Valor cuantificado por privacidad (máx. 8GB). Valores posibles: 0.25, 0.5, 1, 2, 4, 8 GB' : null,
        hardwareConcurrency: navigator.hardwareConcurrency || null,
        hardwareConcurrencyNote: navigator.hardwareConcurrency ? 'Número de núcleos lógicos disponibles' : null,
    ...
    getHardwareInfo() {
      const info = {
        ...
        coresNote: 'Núcleos lógicos (incluye hyperthreading)',
        memory: navigator.deviceMemory || null,
        memoryNote: 'RAM cuantificada por privacidad (máx. 8GB reportado)'
      };
  ...
  // Verificación de entorno del navegador
  const isBrowser$2 = typeof window !== 'undefined' && typeof fetch !== 'undefined';
  ...
  class RequirementsValidator {
    ...
    async loadRequirements(yamlPathOrObject) {
      try {
        ...
        this.requirements = jsYaml.load(yamlText);
        return this.requirements;
      } catch (error) {
